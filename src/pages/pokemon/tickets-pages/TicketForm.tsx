        ...
        <Container fluid className="p-0">
            ...
            <Container className="d-flex flex-column align-items-center mt-4">
                ...
                <Card className="shadow-lg p-4 mb-4 bg-white rounded" style={{ width: "80%" }}>
                    ...
                    {showSuccessMessage && <Alert variant="success" className="text-center">Ticket registrado correctamente</Alert>}
                    {showErrorMessage && <Alert variant="danger" className="text-center">Error al registrar ticket</Alert>}
